 ...
 * Используется на экране {@link ua.motofun.rss.gui.activity.DashboardActivity}
...
public class NavigationItem {
    ...
    public static NavigationItem[] ITEMS = new NavigationItem[] {
        ...
        new NavigationItem(SETTINGS_ID, R.drawable.ic_map, R.string.title_settings)
    };
    ...
    private static class Adapter extends ArrayAdapter<NavigationItem> {
        ...
        private void displayNavigationTitle(View v, NavigationItem navigationItem) {
            ...
            title.setTypeface(TypefaceUtils.getRobotoLight(getContext()));
        }
